// This version 2 (v2) contains the code version after Michal but before Meleknur + "forEach" loop from Oleksandr
...
// "forEach" loop from Oleksandr
// const elements = await page.locator('span:nth-child(2)').all();
